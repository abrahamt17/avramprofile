    ...
    <>
      ...
      <section id="features" className="mt-9 py-20 lg:py-25 xl:py-30">
        <div className="mx-auto max-w-c-1315 px-4 md:px-8 xl:px-0">
          {/* <!-- Section Title Start --> */}
          <div className=" flex w-full rounded-3xl bg-orange-100 p-10 shadow-2xl md:p-15 lg:p-20 xl:p-25">
            {/* <Image 
            ...
            <SectionHeader
              headerInfo={{
                title: "TRIVIUM FREE GUIDES AND E-BOOKS",
                subtitle:
                  "Download Guides, Cheat Sheets, E-Books, Courses and Other Resources For Free",
                description: `We believe in providing Value To The Market Even For Free. That is why we have prepared Free Resources for you to use and embark on the learning journey.`,
              }}
            />
          </div>
